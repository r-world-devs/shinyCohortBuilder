...
When filters configuration is different across multiple data sources you want to render the filtering panel from scratch everytime the source is updated.
In this scenario:
